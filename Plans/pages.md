...
| `/login` | Client Login | Existing client login; supports `?next=` redirect and `?cr=` to link a just-submitted booking on login; links out to `/signup` for a new account (2026-07-14, `ebb3885` — previously linked to `/hire`) |
