...
## 2026-07-07 — Chat: Message Deletion, Lazy Attachment Loading, File Viewer (uncommitted, in progress)

**What was built:** Continuation of the messaging feature (see the three entries below), currently sitting uncommitted in the working tree on top of `bfde669`. Not yet committed or deployed.
